...
def process_image():
    ...
    # 1. processed_image = process_image_function(image, number)

    # Save the processed image to a BytesIO object
    # img_byte_array = io.BytesIO()
    # processed_image.save(img_byte_array, format='JPG')

    # Reset the stream position to the beginning
    # img_byte_array.seek(0)

    # return send_file(img_byte_array, mimetype='image/jpg')
    # 2. return send_file(processed_image)
